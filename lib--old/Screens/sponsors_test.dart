...
class SponsorsTest extends StatefulWidget {
  const SponsorsTest({Key? key}) : super(key: key);

  @override
  State<SponsorsTest> createState() => _SponsorsTestState();
}

class _SponsorsTestState extends State<SponsorsTest> {
  int index = 0;
                              ...
                              SizedBox(
                                ...
                                child: ListView.builder(
                                    padding: const EdgeInsets.symmetric(
                                        vertical: 10),
                                    itemCount:
                                        snapshot.data?.eventSponsors.length,
